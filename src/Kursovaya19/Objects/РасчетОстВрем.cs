...
namespace IIS.Kursovaya19
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya19.DetailArrayOfОказКонсульт fОказКонсулт;
        ...
        public virtual IIS.Kursovaya19.DetailArrayOfОказКонсульт ОказКонсулт
        {
            get
            {
                ...
                {
                    this.fОказКонсулт = new IIS.Kursovaya19.DetailArrayOfОказКонсульт(this);
                }
                IIS.Kursovaya19.DetailArrayOfОказКонсульт result = this.fОказКонсулт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.Kursovaya19.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.Kursovaya19.РасчетОстВрем));
                }
            }
        }
    }
