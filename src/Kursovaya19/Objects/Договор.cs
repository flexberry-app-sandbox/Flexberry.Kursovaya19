...
namespace IIS.Kursovaya19
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya19.ТипДоговора fТип;
        
        private int fДлительность;
        
        private IIS.Kursovaya19.Статус fСтатус;
        
        private IIS.Kursovaya19.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        
        private IIS.Kursovaya19.Клиент fКлиент;
        ...
        public virtual IIS.Kursovaya19.Статус Статус
        {
            get
            {
                ...
                IIS.Kursovaya19.Статус result = this.fСтатус;
        ...
        public virtual IIS.Kursovaya19.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Kursovaya19.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Kursovaya19.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Kursovaya19.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Kursovaya19.Клиент Клиент
        {
            get
            {
                ...
                IIS.Kursovaya19.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Kursovaya19.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Kursovaya19.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаключДоговораE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаключДоговораE", typeof(IIS.Kursovaya19.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаключДоговораL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаключДоговораL", typeof(IIS.Kursovaya19.Договор));
                }
            }
        }
    }
